                                        ...
                                        <ul>
                                            <li>
                                                <a class="search-result-item" href="product-detail.html">
                                                    <div class="img-box">
                                                        <img src="/assets/images/item/search-grocey1.jpg" alt="">
                                                    </div>
                                            ...
                                            <li>
                                                <a class="search-result-item" href="product-detail.html">
                                                    <div class="img-box">
                                                        <img src="/assets/images/item/search-grocey2.jpg" alt="">
                                                    </div>
                                                    <div class="box-content">
                                            ...
                                            <li>
                                                <a class="search-result-item" href="product-detail.html">
                                                    <div class="img-box">
                                                        <img src="/assets/images/item/search-grocey3.jpg" alt="">
                                                    </div>
                                                    <div class="box-content">
                                            ...
                                            <li>
                                                <a class="search-result-item" href="product-detail.html">
                                                    <div class="img-box">
                                                        <img src="/assets/images/item/search-grocey4.jpg" alt="">
                                                    </div>
                                                    <div class="box-content">
                                            ...
                                            <li>
                                                <a class="search-result-item" href="product-detail.html">
                                                    <div class="img-box">
                                                        <img src="/assets/images/item/search-grocey5.jpg" alt="">
                                                    </div>
                                                    <div class="box-content">
                        ...
                        <div class="box-left">
                            <div class="tf-list-categories">
                                ...
                                <div class="list-categories-inner toolbar-shop-mobile">
                                    ...
                                    <div class="categories-bottom">
                                        <a href="shop-collection-sub.html" class="tf-btn btn-line collection-other-link"><span>View all collection</span><i class="icon icon-arrow1-top-left"></i></a>
                                    </div>
                                </div>
                            </div>
                            <nav class="box-navigation text-center">
                                <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                                    <li class="menu-item">
                                        <a href="/home" class="item-link">Home<i class="icon "></i></a>
                                       
                                    </li>
                                    <li class="menu-item">
                                        <a href="/shop" class="item-link">Shop<i class="icon "></i></a>
                                      
                                    </li>
                                    <li class="menu-item">
                                        <a href="#" class="item-link">Products<i class="icon "></i></a>
                                        
                                    </li>
                                    <li class="menu-item position-relative">
                                        <a href="#" class="item-link">Pages<i class="icon "></i></a>
                                        
                                    </li>
                                    <li class="menu-item position-relative">
                                        <a href="#" class="item-link">Blog<i class="icon "></i></a>
